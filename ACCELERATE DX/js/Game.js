  ...
  var shift = null;
    ...
    return {
        ...
        create: function () {
          ...
          carHorn = game.add.audio('carHorn');
          ...
          boostText = game.add.text(10, 56, "Boost: \n Available", {
            font: "14px Courier",
            fill: "#1e8",
            align: "left"
          });
        ...
        update: function () {
          ...
          distance -= speed;
          if (Math.floor(60000 - distance) > shared.highscore)
          {
            shared.highscore = Math.floor(60000 - distance);
          }
